        ...
        <div className="min-h-screen bg-white">
            <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                ...
                <div className="mb-12 text-center text-balance">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 text-blue-600 mb-6 text-[10px] font-black uppercase tracking-widest">
                        <Sparkles size={14} />
                        <span>Curated Experiences</span>
                    </div>
                    <h1 className="text-4xl sm:text-6xl font-black text-gray-900 mb-6 tracking-tight uppercase leading-none">
                        Best <span className="text-blue-600">Hangout</span> Places <br className="hidden md:block" /> 
                        With Upcoming Events
                    </h1>
                    <p className="text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed uppercase font-medium tracking-wide">
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        {FEATURED_CITIES.map((city) => (
                            <Link
                                ...
                                className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-gray-50 hover:bg-white border border-transparent hover:border-gray-200 text-gray-900 text-xs font-black uppercase tracking-widest transition-all hover:shadow-xl hover:shadow-gray-100 group"
                            >
                ...
                {/* Call to Action */}
                <div className="mt-20 p-8 md:p-16 rounded-[3rem] bg-gray-900 text-white relative overflow-hidden group">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                        <div className="max-w-xl text-center md:text-left">
                            ...
                            <p className="text-gray-400 text-lg mb-0 uppercase font-medium tracking-wide">
                        ...
                        <Link 
                            ...
                            className="shrink-0 inline-flex items-center gap-3 bg-white text-black px-12 py-6 rounded-2xl font-black uppercase tracking-widest hover:bg-gray-100 transition-all transform hover:scale-105 shadow-2xl group/btn"
                        >
