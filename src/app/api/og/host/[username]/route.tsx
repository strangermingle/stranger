    ...
    return new ImageResponse(
      (
        ...
        >
          ...
          >
            <img
              src={host.logo_url || host.user.avatar_url || 'https://www.strangermingle.com/placeholder-avatar.jpg'}
              style={{
                width: '180px',
                height: '180px',
                borderRadius: '50%',
            ...
            <div style={{ fontSize: '28px', color: '#a5b4fc', marginBottom: '40px', textAlign: 'center' }}>
              {host.tagline || 'Verified Host on StrangerMingle'}
            </div>
          ...
          <div style={{ marginTop: '50px', display: 'flex', alignItems: 'center', gap: '15px' }}>
             <div style={{ fontSize: '32px', fontWeight: '800', color: '#fff' }}>StrangerMingle</div>
