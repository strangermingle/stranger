      ...
      (
        ...
        >
          ...
          <div style={{ marginTop: '40px', display: 'flex', alignItems: 'center', gap: '10px' }}>
             <img src="https://www.strangermingle.com/logo.png" width="40" height="40" style={{ borderRadius: '10px' }} />
             <div style={{ fontSize: '28px', fontWeight: '800', color: '#1f2937' }}>StrangerMingle</div>
          </div>
        </div>
      ) as any,
      {
