...
export const metadata: Metadata = {
    ...
    description: "Looking to make new friends in Coimbatore? Join weekend stranger meetups, offline networking groups, and fun social experiences in Coimbatore.",
    alternates: {
