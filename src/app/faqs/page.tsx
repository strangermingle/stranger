            ...
            <div className="max-w-4xl mx-auto px-8 py-12">
                ...
                <div className="mt-16 bg-gray-50 rounded-xl p-8 border border-gray-200">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <Link href="/about" className="block p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-400 hover:shadow-md transition-all group">
                        ...
                        <Link href="/safety-guidelines" className="block p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-400 hover:shadow-md transition-all group">
                        ...
                        <Link href="/refund-policy" className="block p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-400 hover:shadow-md transition-all group">
                            <h4 className="font-bold text-gray-900 mb-2 group-hover:text-blue-600">Refund Policy</h4>
                            <h4 className="text-sm text-gray-600 font-normal">Clear cancellation and refund terms for event registrations.</h4>
                        </Link>
                        <Link href="/events" className="block p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-400 hover:shadow-md transition-all group">
