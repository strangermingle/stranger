        ...
        <div className="max-w-4xl mx-auto flex gap-4 items-start">
          ...
          <div>
            ...
            <p className="text-amber-800 text-sm leading-relaxed">
              ...
              or{' '}
              <Link href="/advertise-with-us" className="underline font-medium text-amber-900 hover:text-amber-700">
                Advertise With Us
              </Link>{' '}
              pages instead.
            </p>
            ...
            {whatMakesAGoodPartner.map((item, i) => (
              <div
                ...
                className={`border rounded-xl p-4 flex items-start gap-3 ${
                  item.fits ? 'bg-green-50 border-green-100' : 'bg-red-50 border-red-100'
                }`}
              >
                <span
