                    ...
                    <section className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="mb-4 leading-relaxed text-gray-600">
                                    These terms constitute a legally binding agreement between you and <strong>StrangerMingle</strong> (doing business as &quot;Stranger Mingle&quot;). Your continued use of our services signifies your ongoing agreement to these terms.
                                </p>
