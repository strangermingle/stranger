...
export default async function KanpurCityPage() {
    ...
    const kanpurPosts = allPosts.filter(post =>
        post.title?.toLowerCase().includes('kanpur') ||
        post.slug?.toLowerCase().includes('kanpur') ||
        post.tags?.some((tag: string) => tag.toLowerCase() === 'kanpur')
    ).slice(0, 3);

    const popularAreas = [
        { name: "Civil Lines", description: "Kanpur's most sorted locality — wide roads, dependable cafes, and a crowd that is educated, curious, and easy to talk to." },
        { name: "Swaroop Nagar", description: "A dense, lively neighbourhood full of young professionals and students who have plenty to say once someone gets the conversation going." },
        { name: "Kidwai Nagar", description: "Residential, relaxed, and underrated. The kind of area where a good cafe and a small group of strangers is all you need for a solid evening." },
        { name: "Harsh Nagar", description: "Growing steadily and attracting a younger crowd. New eateries keep opening — and each one is a potential venue for the next Stranger Mingle." }
    ];
        ...
        <div className="min-h-screen bg-white selection:bg-blue-500/30">
            ...
            <section className="relative w-full pt-32 pb-20 sm:pt-40 sm:pb-32 flex flex-col items-center text-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <Image
                        src="https://res.cloudinary.com/strangermingle/image/upload/v1774872121/kanpur-lucknow-stranger-mingle-event-place_wgefp7.jpg"
                        alt="kanpur-lucknow-stranger-mingle-event-place"
                        fill
            ...
            <section className="py-12 border-b border-gray-100 bg-gray-50/50">
                <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8">
                    <div className="text-center">
                        ...
                        <div className="text-sm text-gray-500 uppercase tracking-widest font-medium">Kanpurites</div>
                    </div>
                    <div className="text-center">
            ...
            <section id="events" className="w-full max-w-7xl mx-auto px-4 py-20 text-center">
                <div className="mb-12">
                    <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Upcoming Stranger Meetups in Kanpur — Join This Weekend</h2>
                    <p className="text-gray-600 max-w-xl mx-auto">Browse the events below, pick one that fits your schedule, and just show up. No icebreaker prep needed — most attendees come alone and that is entirely the point.</p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    {cityEvents.length > 0 ? (
                        ...
                        <div className="col-span-3 py-12 text-center bg-gray-50 rounded-2xl border border-dashed border-gray-300">
                            <p className="text-xl text-gray-500 font-medium">No upcoming events scheduled in Kanpur yet.</p>
            ...
            <section className="py-24 bg-gray-900 text-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 relative">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-4xl font-bold mb-6">Stranger Mingle Is Spreading Across Kanpur — Locality by Locality</h2>
                            <p className="text-gray-400 text-lg mb-10">
                                From the old-money calm of Civil Lines to the busy lanes of Swaroop Nagar, every part of Kanpur has people worth meeting. We are making sure they find each other — one neighbourhood at a time.
                            </p>
                        ...
                        <div className="relative aspect-square">
                            <Image
                                ...
                                alt="Group of strangers at a Kanpur cafe meetup"
                                fill
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-blue-600 p-8 rounded-3xl shadow-2xl hidden md:block">
                                ...
                                <p className="text-blue-100">Partnered in Kanpur</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 max-w-7xl mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold text-gray-900 mb-4">Why People in Kanpur Are Choosing Stranger Mingle</h2>
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">The Leather City of India has built industries worth billions — yet building a solid friend circle here as an adult remains genuinely difficult. We exist for exactly that reason.</p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-12">
                    <div className="text-center p-8">
                        ...
                        <h3 className="text-xl font-bold mb-4">About Friendships, Nothing Else</h3>
                        <p className="text-gray-600 leading-relaxed">
                            No pitches, no profiles to swipe, no business cards. Just six to ten people sitting together in a good cafe with nothing on the agenda except getting to know each other.
                        </p>
                    </div>
                    <div className="text-center p-8">
                        ...
                        <h3 className="text-xl font-bold mb-4">Safe Spaces, Verified People</h3>
                        <p className="text-gray-600 leading-relaxed">
                            Every person who signs up for a Kanpur event is verified beforehand. We enforce a strict code of conduct so everyone — regardless of gender or background — feels completely at ease.
                        </p>
                    </div>
                    <div className="text-center p-8">
                        ...
                        <h3 className="text-xl font-bold mb-4">Kanpur&apos;s Best Venues, Carefully Chosen</h3>
                        <p className="text-gray-600 leading-relaxed">
                            We scout venues in Kanpur where the ambience does the work — good lighting, manageable noise, and staff who do not hover. The right setting changes everything about a first meeting.
                        </p>
                    </div>
                </div>
            </section>
            ...
            {/* Kanpur Blog Posts */}
            {kanpurPosts.length > 0 && (
                <section className="py-24 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-4">
                        <div className="flex justify-between items-end mb-12">
                            <div>
                                <h2 className="text-4xl font-bold text-gray-900 mb-4">Kanpur City Guides</h2>
                                <p className="text-lg text-gray-600">On-ground guides and first-hand stories about making friends and finding your crowd in Kanpur.</p>
                            </div>
            ...
            <section className="py-24 max-w-5xl mx-auto px-4">
                <div className="bg-linear-to-br from-blue-600 to-purple-700 rounded-[3rem] p-12 sm:p-20 text-center relative overflow-hidden">
                    <div className="relative z-10">
                        <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">Ready to Mingle in Kanpur?</h2>
                        <p className="text-blue-100 text-xl max-w-2xl mx-auto mb-10">
                            Kanpur has always known how to build things that last. Come to the next Stranger Mingle and start building friendships that do the same.
                        </p>
            ...
            {/* Upcoming Activities for Kanpur */}
            <UpcomingExperiences city="Kanpur" currentEventId="" />
                        ...
                        },
                        {
                            ...
                            "itemListElement": [
                                ...
                                },
                                {
                                    ...
                                    "position": 2,
                                    "name": "Kanpur",
                                    "item": "https://www.strangermingle.com/kanpur"
                                }
                            ]
                        }
                    ])
