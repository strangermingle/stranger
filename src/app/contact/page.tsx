            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Have questions, suggestions, or need assistance? Reach out to the <strong>Stranger Mingle</strong> team (a brand of <strong>StrangerMingle</strong>) and we&apos;ll get back to you as soon as possible.
                    </p>
                </div>
