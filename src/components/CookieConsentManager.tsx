...
import { Cookie, Shield, BarChart, Target, Settings, Info, AlertCircle } from 'lucide-react';
        ...
        if (typeof window !== 'undefined') {
            ...
            if (savedConsent) {
                try {
                    ...
                    setTimeout(() => {
                        setPreferences(prev => {
                            const isSame = Object.keys(savedPrefs).every(
                                key => savedPrefs[key as keyof ConsentPreferences] === prev[key as keyof ConsentPreferences]
                            );
                            return isSame ? prev : (savedPrefs as ConsentPreferences);
                        });
                    }, 0);
                } catch (e) {
            ...
            <div className="bg-blue-600 p-8 rounded-3xl shadow-lg text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="leading-relaxed text-lg text-blue-50">
                        This Cookie Policy explains how <strong>Stranger Mingle</strong> (a brand of <strong>StrangerMingle</strong>) uses cookies and similar tracking technologies on our website.
